...
\[
    n \in E\,e\,\emptyset \quad\text{iff}\quad I\,e\,\emptyset = n
\]
...
program should be an number $n$, then the interpreter also produces
$n$. The second part is to show that if the interpreter produces an
answer $n$, then the semantics agrees that $n$ should be the answer.
...
\begin{theorem}
  \label{thm:E-soundness}
  If $n \in E\,e\,\emptyset$, then $I\,e\,\emptyset = n$.
\end{theorem}
...
\begin{theorem}\label{thm:E-complete-reduction}\ \\
