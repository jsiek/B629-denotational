...
\]
We shall prove this in two steps, with a detour through another model
of STLC, the Term Model $T$.
\[
\xymatrix@=15pt{
  E \models e = e' \ar@{=>}[d]^{\;1} \\
  T \models e = e' \ar@{=>}[d]^{\;2} \\
...
[TODO: discuss the general notion of homomorphism in other,
simpler settings. --Jeremy]
