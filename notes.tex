...
straightforward of the graph models, that of \citet{Siek:2017ab}.
...
\[
  ...
  \left\{ d' \middle|
  \begin{array}{l}\exists t d d_2.\, t \in D_1, d_2 \in D_2, \\
...
The domain $\mathcal{D}$ consists of just the natural numbers and
...
\section{Graph models of $\lambda$-calculus $(T^{*}_C,D_A,\mathcal{P}(\omega))$ }
