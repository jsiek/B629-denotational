...
\newcommand{\PSEM}[1]{\mathcal{E}_T\,#1\,}


\begin{figure}
\begin{align*}
  \mathbb{D} &= \mathbb{N} + \mathcal{P}_f(\mathbb{D}) \times \mathcal{P}_f(\mathbb{D}) \\
  D & \in \mathcal{P}_f(\mathbb{D}) \\[2ex]
%% \PSEM{ n }\rho &= \{ n \} \\
...
P & : \mathbb{E} \to (\mathit{Id} \to \mathcal{P}(\mathit{Nat})) \to \mathcal{P}(\mathit{Nat}) \\
P\,x\,\rho &= \rho\,x \\  
P\,(\LAM{x}e)\,\rho &= \{ \langle n, m \rangle \mid m \in P\,e\,[x\mapsto e_n]\rho \} \\
P\,(e_1\,e_2)\,\rho &= \{ m \mid \exists e_n. \, 
   \langle n,m \rangle \in P\,e_1\,\rho
   \text{ and } e_n \subseteq P\,e_2\,\rho \}\\
\end{align*}
