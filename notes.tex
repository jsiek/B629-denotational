...
Resources: \citet{Scott:1970dp,Scott:1971aa}, \citet{Stoy:1977aa}
...
\begin{align*}
 up &: D_{\infty} \to [D_{\infty} \to D_{\infty}] \\
 down &: [D_{\infty} \to D_{\infty}] \to D_{\infty}
\end{align*}
But we have some work to do before we can define them.
