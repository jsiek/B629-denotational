...
\label{lem:subst-model}
  ...
  \item If $\forall \rho, \SEM{ [x\by e']e} \rho = \SEM{e}\ext{x}{\SEM{e'}\rho}{\rho}$, then
    $\forall \rho, \SEM{ ([x\by e']\LAM{y}e)} \rho = \SEM{(\LAM{y}e)}\ext{x}{\SEM{e'}\rho}{\rho}$.
...
\item 
  ...
  \begin{itemize}
  \item Assume $x \in \mathrm{FV}(e')$.
  \item Assume $x \notin \mathrm{FV}(e')$.
    Let $\rho'=\ext{x}{\SEM{e'}\rho}{\rho}$
    and $d \in D$ be an arbitrary element.
    \begin{align*}
           \SEM{[x\by e']e}\ext{y}{d}{\rho'}
        &= \SEM{[x\by e']e}\ext{y}{d}{\rho} & \text{condition \ref{cond:env}}\\
        &= \SEM{e}\ext{x}{\SEM{e'}\rho}{\ext{y}{d}{\rho}} & \text{by \eqref{eq:phi-subst}} \\
        &= \SEM{e}\ext{y}{d}{\rho'}
    \end{align*}
