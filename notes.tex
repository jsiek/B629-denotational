...
\begin{align*}
  \SEM{\emptyset} &= \UNITTY \\
  \SEM{\Gamma,x\of A} &= \SEM{A} \times \SEM{\Gamma}
\end{align*}
...
environment $\rho$ is a tuple of values (not a mapping from variables
to values) so environment lookup is performed by consulting the type
environment $\Gamma$ to determine the position $n$ of a variable $x$,
and then selecting the $n$th element from $\rho$.
...
\intertext{$E : \prod (e : \EXP), \SEM{\Gamma} \to \SEM{A} \qquad \text{where } \Gamma \vdash e : A$}
  ...
  E\,(\LAM{x\of A}e)\,\rho &= \{ (d,d') \mid d \in \SEM{A} \text{ and } d' = E\,e\,(d,\rho) \} \\
...
\begin{lemma}[Substitution]
  ...
  $E\,([x\by e']e)\,\rho = E\,e\,(E\,e'\,\rho, \rho)$
\end{lemma}
\begin{proof}
   (page 51 of Gunter)
  The proof is by induction on $e$.
  ...
  \item Case $e=n$:
    \[
    E\,([x\by e']n)\,\rho = n = E\,n\,(E\,e'\,\rho,\rho)
    \]
  \item Case $e=e_1 \oplus e_2$:
    \begin{align*}
      ...
      &= E\,e_1\,(E\,e'\,\rho, \rho) \oplus E\,e_2\,(E\,e'\,\rho, \rho) & \text{I.H.}\\
      &= E\,(e_1 \oplus e_2)\,(E\,e'\,\rho, \rho) & \text{def. $E$}
    \end{align*}
