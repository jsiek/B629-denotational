...
We define the equivalence class of all expression that are equal
according to the theory.
\[
  [e] = \{ e' \mid \; \vdash e = e' \}
\]
We also define the equivalence class of expressions of a given type
that are equal according to the theory.
\[
  \mathcal{T}\SEM{A} = \{ [e] \mid \Gamma \vdash e : A \}
\]
