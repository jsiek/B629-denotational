...
Question: what is the relationship between $\epsilon{-}\delta$
continuity and continuity for complete partial orders.
...
\begin{definition}[Continuous]
  ...
  \]
  or equivalent, in terms of open intervals,
  \[
...
\begin{definition}[L-Continuous]
  Suppose $f : A \to \Reals$ and $A \subseteq \Reals$.
  The function $f$ is l-continuous at $c$ if $\lim_{x\to c} f(x) = f(c)$.
\end{definition}
